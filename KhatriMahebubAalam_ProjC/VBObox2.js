...
function VBObox2() {
    ...
    '   v_Ke = u_MatlSet[0].emit;\n' +
    '   v_Ka = u_MatlSet[0].ambi;\n' +
    '   v_Ks = u_MatlSet[0].spec;\n' +
    '}\n';
    ...
    '   vec3 L = normalize(u_LampSet[0].pos - v_Position.xyz);\n' +

    '   float nDotL = max(dot(N, L), 0.0); \n' +
    '   vec3 ED = normalize(u_eyePosWorld - v_Position.xyz); \n' +
    '   vec3 H = normalize(L + ED); \n' +
    ...
    '	vec3 emissive =	v_Ke;\n' +
    '   vec3 diffuse = u_LampSet[0].diff * v_Kd * nDotL * u_Multipliers.x;\n' +
    '   vec3 ambient = u_LampSet[0].ambi * v_Ka * u_Multipliers.y;\n' +
    '	vec3 speculr = u_LampSet[0].spec * v_Ks * specular * u_Multipliers.z;\n' +
...
VBObox2.prototype.setMatrices = function() {
...
VBObox2.prototype.drawCylinder = function() {
    this.setMatrices();
    gl.drawArrays(gl.TRIANGLES, this.shapes[9], this.shapes[10]);   
}

VBObox2.prototype.drawBranch = function(angle, iter) {
    if (iter < 3) {
...
VBObox2.prototype.drawTentacle = function(angle) {
    pushMatrix(this.modelMatrix);
...
VBObox2.prototype.drawPyramid = function() {
    this.setMatrices();
    gl.drawArrays(gl.TRIANGLES, this.shapes[11], this.shapes[12]);   
}

VBObox2.prototype.drawSpinningPyramids = function(angle1, angle2, angle3) {
    pushMatrix(this.modelMatrix);
...
VBObox2.prototype.reloadMaterial = function() {
